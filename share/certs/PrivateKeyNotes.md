...
unlocked to sign the Piratescoin-Qt.app bundle.
...
allowing somebody to distribute a Piratescoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the piratescoin-qt.exe file inside the installer had not been tampered with.

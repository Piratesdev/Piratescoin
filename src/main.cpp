...
uint256 hashGenesisBlock("0x00000000f1e72369d949e9329326b8d53057b402fe78f5a0e90ddc536cb1c618");
...
bool CTxOut::IsDust() const
{
    ...
    // so dust is a txout less than 54 uPTE
...
if(nHeight == 1) { nSubsidy = 304000 * COIN; } 
...
static const int64 nTargetTimespan = 9000; // two weeks
...
void ThreadScriptCheck() {
    RenameThread("piratescoin-scriptch");
...
void SetGenesisHash() {
        ...
        // Genesis block
        const char* pszTimestamp = "The PiratesCoin !!!!!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1416392401;
        block.nBits    = 0x1d00ffff;
        block.nNonce   = 2536895781;
        ...
        assert(block.hashMerkleRoot == uint256("0x0a72e5e8ebc49f0583a5f0cbb9a87fa32396b97824033da50529277ec2560983"));
        block.print();
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("PiratescoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("PiratescoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("PiratescoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("piratescoin-miner");
    ...
    try { loop {
        ...
        printf("Running PiratescoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("PiratescoinMiner terminated\n");
        throw;
    }
}
